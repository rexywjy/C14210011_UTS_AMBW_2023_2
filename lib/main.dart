      ...
      home: Scaffold(
        appBar: AppBar(
          leading: 
            ...
            Container(
              ...
              // color: Colors.amber,
              child: 
              // if currentPageIndex == 0 it will show the icon
              currentPageIndex == 1 ? GestureDetector(
                  onTap: () {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // ),
                      // Text('Back to Home', style: TextStyle(fontSize: 16.0, color: Colors.blue)),
                    ],
                  ),
                ) : CircleAvatar(
                backgroundImage: AssetImage('assets/images/nomnom.png'),
        ...
        bottomNavigationBar: NavigationBar(
          ...
          destinations: const <Widget>[
            ...
            NavigationDestination(
              icon: Badge(child: Icon(Icons.qr_code_scanner_sharp)),
              label: 'Scan',
            ),
            NavigationDestination(
        ...
        body: <Widget>[
          ...
          child: ListView(
            children: [
              Container(
                padding: EdgeInsetsDirectional.only(start: ((MediaQuery.of(context).size.width < 750) ? 0 : (MediaQuery.of(context).size.width < 1200 ? 100 : 250)), end: ((MediaQuery.of(context).size.width < 750) ? 0 : (MediaQuery.of(context).size.width < 1200 ? 100 : 250)), top: 20, bottom: 10),
                child: Column(
                  children: [
                    CarouselSlider(
          ...
          Padding(
            ...
            child: ListView(
              children: [
                Container(
                  margin: EdgeInsetsDirectional.only(start: (MediaQuery.of(context).size.width < 700) ? 10 : (MediaQuery.of(context).size.width < 900 ? 100 : (MediaQuery.of(context).size.width < 1300 ? 200 : 350)), end: (MediaQuery.of(context).size.width < 700) ? 10 : (MediaQuery.of(context).size.width < 900 ? 100 : (MediaQuery.of(context).size.width < 1300 ? 200 : 350)), top: 5, bottom: 20),
                  child: Material(
                    elevation: 5,
                    child: 
                      FillImageCard(
                        width: 4000,
                        heightImage: 220,
                        imageProvider: AssetImage('assets/images/mcd.jpg'),
                        tags: [Icon(Icons.star, color: Colors.amber,), Text('4.7/5')],
                        title: Text('Mc Donald\'s', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                        description: Text('Burger, Chicken, Fries, Cafe, etc'),
                        // color: Colors.amber,
                      ),
                  ),
                ),
                  ...
                  child: Material(
                    ...
                    child: 
                      FillImageCard(
                        width: 4000,
                        heightImage: 220,
                        imageProvider: AssetImage('assets/images/kfc2.jpeg'),
                        tags: [Icon(Icons.star, color: Colors.amber,), Text('4.6/5')],
                        title: Text('KFC', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                        description: Text('Chicken, Burger, Fries, etc'),
                        // color: Colors.amber,
                      ),
                  ),
                ),
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  child: Text('Scan QR Code to get the menu of the restaurant', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                ),
                Container(
                  width: 400,
                  height: 400,
